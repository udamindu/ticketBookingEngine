...
/**
 * Servlet implementation class SVGEditorPopupServlet
 */
@WebServlet("/SVGEditorPopupServlet")
public class SVGEditorPopupServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SVGEditorPopupServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		System.out.println("LEOOO"+ request.getParameter("id"));
		svgP.setId(Integer.parseInt(request.getParameter("id")));
		...
		svgP.setNoOfCovers(Integer.parseInt(request.getParameter("tables")
				.toString()));
		svgP.setLocation(1); // FIXME : Hardcoded
