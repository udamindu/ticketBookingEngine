...
public class FileUploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		// Commom variable initialization
		...
		String uploadPath = config.getLocPicPath();
		...
		String Url = filePath ;
		String Location = "1";
		String Description = "Not Given";
		
		LocationPicturesController LPC = new LocationPicturesController();
		LPC.addNewPicTemp(Url);
		
		/*LocationPictures lp = new LocationPictures(Name,Url,Location,Description);
		lp.insertData();
		*/
