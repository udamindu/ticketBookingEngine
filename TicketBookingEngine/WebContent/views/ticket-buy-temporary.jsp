            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Buy tickets
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 form-group">
                        ...
                        <form name="form1" method="get" action="/TicketBookingEngine/TemporaryServlet" autocomplete="on">
						<!-- start id-form -->	
						<table class="table" id="id-form">
							<tr>
								...
								<%Events newEvent = new Events();
								  int companyId = 3; // hard coded
								  Vector<Vector<String>> resultSet = newEvent.getNameIdPair(companyId);
								  String pairName ="";
		                          String pairId = "";
								%>
									<select  class="form-control inp-form" name="type" id="type">
								<%  for(Vector<String> pair:resultSet){ 
									pairId = pair.get(0);
									pairName = pair.get(1);									
								%>
							...
							<tr>
								...
								<td>		
									<!-- <input type="text" name="location" class="form-control inp-form" onblur="hidePara('#err1')" required>-->
									<select  class="form-control inp-form" name="location" id="location">
										<option value="Sliit Auditorium">Sliit Auditorium</option>
										<option value="Hall 307">Hall 307</option>
										<option value="Hall 308">Hall 308</option>
										<option value="Hall 202">Hall 202</option>
										<option value="Hall 205">Hall 205</option>
										<option value="Sliit Open Area">Sliit Open Area</option>
							...
							<tr>
								...
								<td>
									<textarea rows="" cols="" class="form-control inp-form" name="description"></textarea>
								</td>
								<td></td>
							</tr>
