...
<script type="text/javascript">
 ...
 <div id="wrapper" ng-app="TBE" ng-controller="Resourse_Update">
    ...
    <form id="form1" method="post" action="/TicketBookingEngine/searchR" >               
                   
    	<div  class="col-lg-3" >
        <label>Search Item Category:</label>
    ...
    <form id="mainform" action="/TicketBookingEngine/deleteallResources" method = "post">
       ...
       <tbody>
			...
			<%
				...
				{
				   	Enquiry = em.SearchResource(request.getAttribute("key").toString()); // to search
						
				} 
				else 
				{
					Enquiry = em.getResourseDetails();
				}	
            ...
            <tr>
				...
				<td><button type="button" name="btnEd" onclick=openPage("/TicketBookingEngine/views/resourse-edit/resourse-editform.jsp<%=QString %>") class="fa fa-pencil-square-o fa-2x"></button>
