            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Edit an Event
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                		...
                		<%if(request.getParameter("eid")!=null){
                			...
                			Events e = new Events();
                			Vector<Vector<String>> eventdes = e.getEvent(id);
                			              			              			               			
                			int i = 0;
                			
                			for(Vector<String> Enq:eventdes){
								id = Enq.get(0);
								names = Enq.get(1);
								type = Enq.get(2);
								loc = Enq.get(3);
                ...
                %>
                    <div class="col-lg-6 form-group">
                        ...
                        <form name="form1" method="get" onsubmit="return checkForNull()" action="/TicketBookingEngine/EditEventsServlet" autocomplete="on">
						<!-- start id-form -->	
